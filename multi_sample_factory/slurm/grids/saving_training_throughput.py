...
_name = 'grid_saving_training_throughput'
_base_parameters = '--env_params=difficulty:14 --experiment_summaries_interval=5 --decorrelate_experience_max_seconds=0 --decorrelate_envs_on_one_worker=False'
