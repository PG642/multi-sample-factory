...
from multi_sample_factory.utils.utils import log, AttrDict, memory_consumption_mb, join_or_kill, set_process_cpu_affinity, \
    ...
    def _process_rewards(self, rewards, env_i):
        ...
        for agent_i, r in enumerate(rewards):
            try:
                ...
                print('r:', r)
                print('self.actor_states[env_i][agent_i].last_episode_reward:', self.actor_states[env_i][agent_i].last_episode_reward)
