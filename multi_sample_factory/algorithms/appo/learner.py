            ...
            for batch_num in range(len(minibatches)):
                ...
                with timing.add_time('update'):
                    ...
                    try:
                        ...
                        print('Ratio contains nans:', torch.isnan(ratio).any())
                        print('Log probs contains nans:', torch.isnan(log_prob_actions).any())
                        print('Mini batch log probs contains nans:', torch.isnan(mb.log_prob_actions).any())
