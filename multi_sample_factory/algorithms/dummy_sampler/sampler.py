...
# python -m multi_sample_factory.run_algorithm --algo=DUMMY_SAMPLER --env=doom_benchmark --env_frameskip=4 --res_w=128 --res_h=72 --wide_aspect_ratio=False --num_workers=20 --num_envs_per_worker=10 --sample_env_frames=2000000 --experiment=test
# python -m multi_sample_factory.run_algorithm --algo=DUMMY_SAMPLER --env=dmlab_benchmark --env_frameskip=4 --num_workers=20 --num_envs_per_worker=10 --sample_env_frames=2000000 --experiment=test
