...
class EnvRegistry:
    ...
    def register_env(
        ...
        See the multi_sample_factory_examples for the default envs, it's actually very simple.
    ...
    def resolve_env_name(self, full_env_name):
        ...
        msg = (f'Could not resolve {full_env_name}. '
               'Did you register the family of environments in the registry? See multi_sample_factory_examples for details.')
        log.warning(msg)
